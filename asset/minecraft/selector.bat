...
echo.
echo  ---------------------------------------------------------------------
echo                                Minecraft folder management
echo.
echo           Hey slt c'est juste pour ouvrir/changer des fichier dans ton 
echo           Ton .minecraft (mai ganre automatiqeman)
echo.     
echo.
echo.
echo.
...
:Shader
start %appdata%\.minecraft\Shaderpacks
goto question 
...
xcopy C:\users\%username%\AppolonKIT\asset\minecraft\servers.dat %appdata%\.minecraft > nul
echo Good !!
pause
goto question
...
xcopy C:\users\%username%\AppolonKIT\asset\minecraft\OptionsLC.txt %appdata%\.minecraft > nul
echo Good !!
pause
goto question
